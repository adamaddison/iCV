...
$scope.dateRanges = ["September 2019 - September 2020", "September 2015 - May 2019", "September 2013 - June 2015", "September 2008 - June 2013"];
   ...
   // END UNIT TESTING
	...
	$scope.profile={title: "Profile", text: "Since the age of 14 I have been self-taught in C#, Java and other languages (JavaScript, C++, PHP and MySQL) and I achieved Distinctions in both first and second years of my BTEC course in Software Development at Gloucestershire College resulting in gaining 'top student' award in 2014 and 2015 based on my marks and quality of my assignments. \n\nAfter gaining a scholarship and entry to a 4-year Software Engineering degree at Stirling University in 2015 I successfully developed my professional software engineering skills and complimented them with successful grades in business and economics modules. \n\nWhile I have done well academically I have actively put my skills to practice in supporting others and started the first big data sub group within the Stirling University computer club to instruct and educate others on useful programming topics in this area of engineering. In this group, after research and self-directed study, I gave presentations on big data (what it is and what it's uses are) and demonstrated how to use the 'R' programming language for big data and data analysis operations. This has encouraged other students to look more closely into the field of big data to better appreciate future career options. \n\nFor my fifth semester (3rd Year), I successfully studied abroad in the USA at the University of Northern Iowa (UNI), where I adapted well to the faster pace of work common in US Universities, meaning an increased set of deadlines to meet, more group work, as well as having to take 4 rather than 3 modules. The outcome of this period of study was that I gained an excellent insight to studying abroad and a greater awareness and appreciation of undertaking a degree as part of a global contingent of students as well as successfully achieving distinctions throughout my modules. \n\nI graduated from Stirling University with a 1st class honours degree in June 2019. During that summer I worked in a summer internship as a Java developer and tester at Sky Subscribers Limited. In September that year I started studying for a one-year taught masters degree in Software Engineering at Southampton University, graduating in November 2020 with a merit. After finishing my masters degree in September 2020 I then started a graduate scheme with Ultra Electronics, and in August 2021 I joined Bridewell Consulting as a junior security developer, where I developed assessment web applications for cybersecurity consultants. I began my current role as a software developer at Ofgem in November 2022, where I develop and maintain the web applications for their energy incentive schemes. \n\nI am keen to demonstrate my current programming skills within the workplace applying my strong knowledge of SDLC frameworks on real-world opportunities and from this acquire new skills as well as add value to a future prospective employer in delivering a quality product/service within the computing/software engineering field. ", pictureURL: "img/IMG_1013.HEIC"};
...
"Making the Most of the World Wide Web (CSCU9B2) – Distinction (87/100)"
	...
	$scope.skills = {text: "Adam's key areas of technical expertise are:<ul> <li>Knowledge and experience of using C# to build desktop apps as well as dynamic web apps that work with SQL Server to generate frontend content and work in a production environment</li> <li>Developing cloud solutions with Azure and AZ-204 certification</li> <li>Significant experience with Java and using Java frameworks such as JUnit, Apache Tomcat, JSP</li> <li>Application of Waterfall and RAD / Agile frameworks for SDLC when modelling programs.</li> <li>Application of JavaScript, HTML, CSS and Angular framework to develop web applications</li> <li>Strong knowledge of designing and testing graphical and command line programs and using either Git or SVN to manage changes and promoting code for delivery.</li> <li>13 years' experience in developing in-house programs using modern programming languages since the age of 14</li> </ul>"};

	$scope.training = {text: "<ul> <li>Azure development / AZ-204 certification</li> <li>Visual Studio 2022</li> <li>Visual Studio Code for JavaScript development</li> <li>Ecommerce Technologies</li> <li>XAMPP</li> <li>Azure DevOps for CI/CD processes</li> <li>HCI</li> <li>Neural Networks and Bayesian Networks</li> <li>JIRA for Issue Tracking & Project Management</li> <li>Project Planning and Software Development Methodologies (both waterfall and agile)</li> <li>Angular for building single page web applications</li> </ul>"};
	
	$scope.recentExperience = [{header: "AZ-204 Microsoft Azure Certification", date: "July 2022", text: "In the spring and summer of 2022 I studied for the Microsoft Azure Developer Associate certification. During this time I did a combination of reading through Microsoft Learn modules, doing practise questions, and implementing Azure developer technologies in practical software projects. After this period of study I took the AZ-204 exam that July and passed it to gain the Azure Developer Associate certification. This certification covers the following topics:<ul><li>Blob and database storage</li><li>Secure solutions</li><li>Monitoring and logging</li><li>Event / messaging systems</li><li>Function Apps</li><li>App Service Web Apps</li><li>Containers</li><li>Authentication and authorisation</li><li>API Management</li></ul>The knowledge I have gained in studying for this certification has made me more able to develop applications and solutions using Azure cloud services, and I have since used these skills in various projects. I recently renewed this certification in July 2024.", imageURL1: "img/azure1.png", imageURL2: "img/azure2.png"}];
