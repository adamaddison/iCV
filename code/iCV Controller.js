...
"UI Design, Implementation, and Evaluation (CS3120) – Distinction (3.67/4)*", "Software Engineering (CS2720) – Distinction (4/4)*","Web Application Development (CS3110) – Distinction (4/4)*","Database Systems (CS3140) – Distinction (4/4)*","<b>2nd Year Modules</b><br>","Data Structures & Algorithms (CSCU9A3) – Distinction (88/100)","Introductory Microeconomics (ECNU111) – Distinction (98/100)","The Global Business Environment (MGTU9S1) – Distinction (75/100)","Managing Information (CSCU9T4) – Distinction (72/100)","Systems (CSCU9V4) – Merit (61/100)","Programming Language Paradigms (CSCU9Y4) – Distinction (87/100)","<b>1st Year Modules</b><br>","Computer Science (CSCU9A1) – Distinction (88/100)","Discrete Structures (MATU9D1) – Distinction (84/100)","Mathematics 1 (Pure Maths) (MATU9M1) – Pass (55/100)","Programming and UI Design (CSCU9A2) – Distinction (81/100)","Practical Statistics (MATU9D2) – Distinction (74/100)","Making the Most of the World Wide Web (CSCU9B2) – Distinction (87/100)"], imageURL: "img/stir.jpg", footnote: "*5th Semester grades are based on the American grade system after studying at University of Northern Iowa, and so the grades show marks out of 4 and not 100"},
	...
	$scope.skills = {text: "Adam’s key areas of technical expertise are:<ul><li>Knowledge and experience of using C# .NET Core to build desktop apps as well as dynamic web apps that work with SQL Server to generate frontend content and run in a production environment</li><li>Significant experience with programming in Java and using Java frameworks such as JUnit, Apache Tomcat, and JSP</li><li>Adaptable at learning new programming languages i.e. Java, C#, C++, R, PHP, JavaScript + HTML + CSS</li><li>Application of Waterfall and RAD / Agile frameworks for SDLC when modelling programs.</li><li>Application of JavaScript, HTML, CSS and AngularJS / Angular 2+ to develop web applications</li><li>Strong knowledge of designing and testing graphical and command line programs and using SVN or Git to manage changes and promoting code for delivery.</li><li>Over 12 years’ experience in developing in-house programs using modern programming languages since the age of 14</li></ul>Adam’s key personal skills are:<ul><li>Positive team worker with an eye for detail when developing and designing software programs</li><li>Attention to detail when designing and writing programs (best practice commenting is followed)</li><li>Excellent document presentation skills when designing and communicating programs</li><li>Strong work ethic (Completer/Finisher)</li><li>Excellent problem-solving skills when identifying and overcoming programming errors</li><li>Work closely with my peers to meet and surpass objectives and assist them in their tasks</li></ul>"};

	$scope.training = {text: "<ul><li>.NET Core</li><li>Azure development / AZ-204</li><li>Visual Studio 2022</li><li>AngularJS and Angular 2+ for building single page web applications</li><li>Notepad++ (to support PHP code development)</li><li>Project Planning and Software Development Methodologies (both waterfall and agile)</li><li>T-SQL</li><li>Development using the Clean Architecture</li><li>Ecommerce Technologies</li><li>R Programming for Data Analysis</li><li>XAMPP</li><li>JIRA for Issue Tracking & Project Management</li><li>HCI</li><li>Adobe Fireworks for designing program graphics</li></ul>"};
	
	$scope.recentExperience = [{header: "AZ-204 Microsoft Azure Certification", date: "July 2022", text: "In the spring and summer of 2022 I studied for the Microsoft Azure Developer Associate certification. During this time I did a combination of reading through Microsoft Learn modules, doing practise questions, and implementing Azure developer technologies in practical software projects. After this period of study I took the AZ-204 exam that July and passed it to gain the Azure Developer Associate certification. This certification covers the following topics:<ul><li>Blob and database storage</li><li>Secure solutions</li><li>Monitoring and logging</li><li>Event / messaging systems</li><li>Function Apps</li><li>App Service Web Apps</li><li>Containers</li><li>Authentication and authorisation</li><li>API Management</li></ul>The knowledge I have gained in studying for this certification has made me more able to develop applications and solutions using Azure cloud services, and I have since used these skills in various projects. I recently renewed this certification in May 2023.", imageURL1: "img/azure1.png", imageURL2: "img/azure2.png"}];
